...
class TravelCostCoefficientCalculator {
    ...
    @Autowired private TravelCancellationTravelCostCoefficientRepository travelCancellationTravelCostCoefficientRepository;

    BigDecimal calculate(PersonDTO person) {
        return travelCancellationTravelCostCoefficientRepository.findCoefficient(person.getTravelCost())
