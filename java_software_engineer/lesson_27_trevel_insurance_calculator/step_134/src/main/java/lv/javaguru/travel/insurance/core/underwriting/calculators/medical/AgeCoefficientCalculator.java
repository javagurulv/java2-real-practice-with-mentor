...
class AgeCoefficientCalculator {
    ...
    @Autowired private TravelMedicalAgeCoefficientRepository travelMedicalAgeCoefficientRepository;
    ...
    private BigDecimal getCoefficient(PersonDTO person) {
        ...
        return travelMedicalAgeCoefficientRepository.findCoefficient(age)
